...
#include <my_pass_frag.h>

namespace Pilot
{
    void PMyPass::initialize(VkRenderPass render_pass, VkImageView input_attachment)
    {
    ...
    void PMyPass::setupDescriptorSetLayout()
    {
    ...
    void PMyPass::setupPipelines()
    {
        ...
        VkShaderModule frag_shader_module =
            PVulkanUtil::createShaderModule(m_p_vulkan_context->_device, MY_PASS_FRAG);
        ...
        pipelineInfo.subpass             = _main_camera_subpass_my_pass;
    ...
    void PMyPass::setupDescriptorSet()
    {
    ...
    void PMyPass::updateAfterFramebufferRecreate(VkImageView input_attachment)
    {
    ...
    void PMyPass::draw()
    {
        if (m_render_config._enable_debug_untils_label)
        {
            VkDebugUtilsLabelEXT label_info = {
                VK_STRUCTURE_TYPE_DEBUG_UTILS_LABEL_EXT, NULL, "My Pass", {1.0f, 1.0f, 1.0f, 1.0f}};
